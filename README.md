...
- **Edition**: Community
- **Version**: `2.2.2-community` (**stable**)
- **Stable release**: `2.2.2-community` — the current production line, built on the stable [dbsgomysql v1.2.0 integration](docs/README_dbsgomysql.md).
