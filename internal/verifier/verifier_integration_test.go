...
func TestVerifier_SHA256_RealMySQLTypes_Integration(t *testing.T) {
	...
	v.SetColumnMetadata(map[string]types.ColumnMetadata{"ga9_verify_types": {Names: []string{"id", "d", "ts", "vb", "s", "f"}, Temporal: map[string]types.TemporalKind{"ts": types.TemporalDateTime}}})
