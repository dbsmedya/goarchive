...
================================================
  ...
  fmt-check          ok
  ...
  integration        PASS=1076 FAIL=0 SKIP=1
...
```
[INFO] integration: PASS=1076 FAIL=0 SKIP=1 (go test exit 0)
```
...
tests — inclusive, so `MIN_PASS=1076` accepts exactly 1076. It defaults to 1, which only
